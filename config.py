    ...
    def load_config(self) -> AppConfig:
        ...
        try:
            self._config = AppConfig(
                ...
                rootly=RootlyConfig(api_base=config_data["rootly"]["api_base"], api_token=secrets["ROOTLY_API_TOKEN"]),
                data_types=DataTypesConfig(
                    incidents=IncidentDataTypeConfig(
                        ...
                        enhanced_data=EnhancedDataConfig(
                            ...
                            include_action_items=config_data["data_types"]["incidents"]["enhanced_data"][
                ...
                logging=LoggingConfig(level=config_data["logging"]["level"], format=config_data["logging"]["format"]),
            )
