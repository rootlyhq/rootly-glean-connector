...
class BaseDocumentMapper:
    ...
    def _extract_author(self, data: dict[str, Any], user_path: str = "user") -> dict[str, str] | None:
        """
    ...
    def _build_content_field(self, text: str, mime_type: str = "text/plain") -> dict[str, str]:
        ...
        """
        return {"mime_type": mime_type, "text_content": text}

    def _create_base_document(
        self, item_id: str, object_type: str, title: str, view_url: str | None = None
    ) -> dict[str, Any]:
        """
