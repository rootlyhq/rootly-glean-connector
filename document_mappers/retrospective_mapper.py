...
def retrospective_to_doc(retrospective: dict) -> models.DocumentDefinition | None:
    """
...
class RetrospectiveDocumentMapper(BaseDocumentMapper):
    ...
    def convert(self, retrospective: dict) -> models.DocumentDefinition | None:
        ...
        try:
            ...
            doc_fields = self._create_base_document(
                item_id=retrospective["id"], object_type="Retrospective", title=title, view_url=attributes.get("url")
            )
