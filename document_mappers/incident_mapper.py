...
def incident_to_doc(incident: dict) -> models.DocumentDefinition | None:
    """
...
class IncidentDocumentMapper(BaseDocumentMapper):
    ...
    def convert(self, incident: dict) -> models.DocumentDefinition | None:
        ...
        try:
            ...
            doc_fields = self._create_base_document(
                item_id=incident["id"], object_type="Incident", title=title, view_url=attributes.get("url")
            )
