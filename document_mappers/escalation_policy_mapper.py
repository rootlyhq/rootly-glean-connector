...
def escalation_policy_to_doc(policy: dict) -> models.DocumentDefinition | None:
    """
...
class EscalationPolicyDocumentMapper(BaseDocumentMapper):
    ...
    def convert(self, policy: dict) -> models.DocumentDefinition | None:
        ...
        try:
            ...
            doc_fields = self._create_base_document(
                item_id=policy["id"], object_type="EscalationPolicy", title=title, view_url=attributes.get("url")
            )
